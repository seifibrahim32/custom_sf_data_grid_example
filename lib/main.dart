...
import 'package:grid/viewmodel/datasources/employee_local_source.dart';
import 'package:grid/models/employee_model.dart';
      ...
      children: [
        Expanded(
          child: CustomizedGridView(
            ...
            allowFiltering: true,
            onClickFilter: (GridColumn gridColumn) async {
              AlertDialog alert = AlertDialog(
                elevation: 3,
                title: Text(gridColumn.columnName),
                content: const Text("The data has been filtered"),
                actions: [
                  TextButton(
